...
<body>
	...
	<div class="footer">
		Copyright &copy; 2016-${fns:getConfig('copyrightYear')} <a href="${pageContext.request.contextPath}${fns:getFrontPath()}">${fns:getConfig('productName')}</a> - Powered By <a href="http://campus_eb.com" target="_blank">CampusEB</a> ${fns:getConfig('version')}
	</div>
